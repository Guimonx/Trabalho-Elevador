...
public class Passageiro extends Thread{
	...
	int id;
   // static int Andar_Inicial ;
	//static int Andar_Destino ;
	 int Andar_Inicial ;
	int Andar_Destino ;
...
//			// Chamar Elevador
//			if(chamadas.EstaDisponivel() == true && chamadas.AndarDestino != Andar_Inicial && chegouDestino == false && entrou_elevador == false)
//			{
//				
//				System.out.println("O passageiro " + id + 
//						" chamou o elevador para o andar: " + Andar_Inicial);
